...
#include "..\Core\src\gui\imgui.h"
#include <vector>

static inline ImVec2 operator+(const ImVec2& lhs, const ImVec2& rhs) { return ImVec2(lhs.x + rhs.x, lhs.y + rhs.y); }
static inline ImVec2 operator-(const ImVec2& lhs, const ImVec2& rhs) { return ImVec2(lhs.x - rhs.x, lhs.y - rhs.y); }

static void ShowNodeEditor(bool* open)
{
	...
	struct Node
	{
		...
		Node(int id, const char* name, const ImVec2& pos, NodeType type, int inputs_count, int outputs_count) { ID = id; strncpy(Name, name, 31); Name[31] = 0; Pos = pos; Type = type;  InputsCount = inputs_count; OutputsCount = outputs_count; }
	...
	if (!inited)
	{
		nodes.push_back(Node(0, "Branch", ImVec2(270, -30), NodeType::BRANCH, 1, 2));
